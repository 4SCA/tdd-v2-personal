...
@DisplayName("ReservationServiceImpl - Unit Test with Mockito")
public class ReservationServiceImplTest {
    ...
    //With InjectMock annotation from the false repository automaticallly
    @InjectMocks
    private ReservationServiceImpl service;

    //getAllReservations
    @Test
    @DisplayName("Returns all reservation from repository")
    void givenReservationsExist_whenGetAllReservation_thenReturnsList(){
